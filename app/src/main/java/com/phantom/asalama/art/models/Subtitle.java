...
public class Subtitle implements Parcelable
{
    ...
    public final static Parcelable.Creator<Subtitle> CREATOR = new Creator<Subtitle>() {
     ...
     * @param fontSize
     */
    public Subtitle(String fontFamily, String fontWeight, String color, String textAlign, String lineHeight, String fontSize, String textDecoration, String fontStyle, String display, String textTransform) {
        super();
