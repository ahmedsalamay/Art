...
public class Caption implements Parcelable
{
    ...
    public final static Parcelable.Creator<Caption> CREATOR = new Creator<Caption>() {
     ...
     * @param fontSize
     */
    public Caption(String fontFamily, String fontWeight, String color, String textAlign, String lineHeight, String fontSize, String textDecoration, String fontStyle, String display, String textTransform) {
        super();
