...
public class Title implements Parcelable
{
     ...
     * @param fontSize
     */
    public Title(String fontFamily, String fontWeight, String color, String textAlign, String lineHeight, String fontSize, String textDecoration, String fontStyle, String display, String textTransform) {
        super();
