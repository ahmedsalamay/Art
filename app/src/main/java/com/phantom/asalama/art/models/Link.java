...
public class Link implements Parcelable
{
     ...
     * @param fontSize
     */
    public Link(String fontFamily, String fontWeight, String color, String textAlign, String lineHeight, String fontSize, String textDecoration, String fontStyle, String display, String textTransform) {
        super();
